...
@user_router.get("/user", tags=['User'], response_model=List[User], status_code=200, dependencies=[Depends(JWTBearer())])
...
@user_router.put('/user/{id}', tags=['User'], response_model=dict, status_code=200)
...
@user_router.delete('/user/{id}', tags=['User'], response_model=dict, status_code=201)
